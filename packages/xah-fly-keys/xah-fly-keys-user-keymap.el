...
(when xfk-use-xah-keys-p
  ...
  (progn
    ...
    (define-key xah-user-keymap (kbd "j t") 'xah-words-move-word-to-page)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-new-word-entry)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-insert-word-entry)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-add-definition)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-add-source)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-add-comment)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-search-next-unbold)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-chinese-linkify)
    (define-key xah-user-keymap (kbd "j k") 'xah-words-annotate)
    (define-key xah-user-keymap (kbd "j e") 'xah-words-word-etymology-linkify)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-query-find-then-bold)
    (define-key xah-user-keymap (kbd "j t") 'xah-words-find-word-usage)
